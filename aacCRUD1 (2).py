...
class CRUD(object):
    ...
    def mongoimport(self, csv_path, header):
        ...
        # 'header' must match the header of the csv doc

        # to make things easier place csv file in the same folder
    ...
    def create(self, data):
        ...
        if data is None or data == {}:
            ...
            if results is None:
                ...
                print("ERROR - Data " + results["name"] + " already in the database.")
